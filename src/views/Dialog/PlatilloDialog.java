...
import models.Platillo.Emblema; // AÑADIDO: Importación del Enum
...
public class PlatilloDialog extends JDialog {
    ...
    private JComboBox<Emblema> emblemaComboBox; // AÑADIDO: Declaración del combo
    ...
    private void inicializarComponentes() {
        ...
        botonCerrar.setForeground(Paleta_Colores.TEXTO_PRINCIPAL.getColor()); // CORREGIDO: Tenías botonFinalizar aquí repetido
    ...
    private JScrollPane crearFormulario() {
        ...
        JLabel lblEmblema = new JLabel("Emblema comercial");
        lblEmblema.setAlignmentX(RIGHT_ALIGNMENT);
        
        emblemaComboBox = new JComboBox<>(new DefaultComboBoxModel<>(Emblema.values()));
        emblemaComboBox.setSelectedItem(Emblema.SUPER); 
        
        //Quita los espacios
        emblemaComboBox.setRenderer(new BasicComboBoxRenderer() {
            @Override
            public Component getListCellRendererComponent(JList<?> list, Object value, int index, boolean isSelected, boolean cellHasFocus) {
                super.getListCellRendererComponent(list, value, index, isSelected, cellHasFocus);
                if (value instanceof Emblema) {
                    setText(((Emblema) value).getValorBaseDatos());
                }
                return this;
            }
        });

        panelFormulario.add(lblEmblema);
        panelFormulario.add(emblemaComboBox);
    ...
    public void desactivarEntradas() {
        ...
        emblemaComboBox.setEnabled(false); // AÑADIDO: También congelamos el combo de emblemas
    }
    ...
    public JComboBox<Emblema> getEmblemaComboBox() {
        return emblemaComboBox;
    }
